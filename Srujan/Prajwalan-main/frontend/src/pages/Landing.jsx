        ...
        <div style={{ minHeight: '100vh', fontFamily: 'Inter, sans-serif', background: 'var(--slate-50)' }}>
            ...
            <nav style={{
                ...
                <div style={{ display: 'flex', gap: 12, alignItems: 'center' }}>
                    <a href="/disaster.html" target="_blank" className="btn btn-sm" style={{ background: '#e63946', color: 'white', border: 'none', fontWeight: 600, display: 'flex', alignItems: 'center', gap: '6px' }}>
                        <span style={{ fontSize: '14px' }}>🚨</span> Disaster Mode
                    </a>
            ...
            <section style={{
                ...
                <div style={{ maxWidth: 800, margin: '0 auto', textAlign: 'center', position: 'relative' }}>
                    ...
                    <div style={{ display: 'flex', gap: 16, justifyContent: 'center', flexWrap: 'wrap' }}>
                        <a href="/disaster.html" target="_blank" className="btn btn-xl" style={{ background: '#e63946', color: 'white', border: 'none', gap: 10, boxShadow: '0 4px 14px rgba(230,57,70,0.3)' }}>
                            🚨 Disaster Mode
                        </a>
